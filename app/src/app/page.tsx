...
export default function HomePage() {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 grid-cols-1">
        <Chart
          ...
          title="Cell Quality by Line (Daily)"
        />
        <Chart
          ...
          type="bar"
          xKey="category"
          yKeys={[{ key: 'count', name: '% Loss' }]}
          title="Capacity Degradation by Chemistry"
        />
      </div>
        </div>
      </div>
  ...
  const domainTab1 = (
    <div className="space-y-6">
      ...
      <Chart
        ...
        xKey="x"
        yKeys={[{ key: 'y', name: 'mΩ' }]}
        title="Impedance Distribution by Batch"
        height={400}
      />
    </div>
  );
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <Chart
          ...
          type="pie"
          xKey="label"
          yKeys={[{ key: 'value', name: 'Risk Index' }]}
          title="Thermal Runaway Risk Score"
        />
        <ActionMemo
          persona={{ name: 'Dr. Pichaya Suwanmanee', role: 'Battery Engineering Lead' }}
          context={{}}
          onGenerate={async () => {
            const memos = [
              {
                ...
                actions: 'Quarantine Batch B-2024-0891 (impedance outlier)', 'Update BMS firmware for temp prediction', 'Schedule aging test for NMC811 cells',
              },
              {
  ...
  const askAiTab = (
    <div className="h-[600px]">
      <AskAI
        title="Ask AI"
        sampleQuestions={[
          'Which batches have impedance above 3-sigma?',
  ...
  const tabs = [
    ...
    { id: 'domain-1', label: 'Cell Analytics', icon: '📈', content: domainTab1 },
    { id: 'domain-2', label: 'Safety & Thermal', icon: '⚡', content: domainTab2 },
